...
const ChatbotOpen = ({ setIsOpen, zoom, handleToggleZoom, handleZoomOut }) => {
  ...
  const iconZoomHeader = zoom ? <box-icon name="minus" color="white"></box-icon> : <box-icon name="square" color="white"></box-icon>

  return (
    <div className="chatbox-wapper">
      <div className="chatbox-header">
        <p>Ultimate Chatbot For Education</p>
        <div className="chatbox-btn chatbox-btn__zoom" onClick={handleToggleZoom}>
          {iconZoomHeader}
        </div>
